  ...
  return (
    <>
      <div className="sideBar md:block lg:block w-[20%] bg-blue-950 h-[100vh] fixed " id='sidebar' style={{ fontFamily: '"Josefin Sans", sans-serif' }}>
          ...
          <NavLink to='/user/dashboard/fund_wallet' className={`text-gray-200 flex text-[1.3rem] items-center gap-2.5 ps-5 mt-2 h-14 justify-items-center align-items-center hover:bg-gray-700 hover:text-white ${location.pathname === '/user/dashboard/fund_wallet' ? 'border-l-4 border-blue-100 ps-4' : ''
            }`}>
            <FaMoneyBills />
            <p>Add money</p>
          </NavLink>
