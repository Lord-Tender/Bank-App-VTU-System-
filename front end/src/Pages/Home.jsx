...
const Home = () => {
  return (
    <>
      ...
      <div className="section2 w-full h-[30em] bg-slate-100 flex border-b-8 border-blue-300 sm:flex-col" style={{ fontFamily: '"Josefin Sans", sans-serif' }}>
        <div className='w-hf sm:w-full sm:mt-10 h-hf flex mt-[-2em] items-center'>
          <div className='ms-[10%]'>
            ...
            <Link to='/user/register'>
              <button className='h-12 bg-sky-400 text-white font-semibold hover:bg-white hover:text-blue-950 w-[10em] rounded-3xl ms-6 mt-5 sm:h-8 sm:text-[0.7em] sm:mt-3'>Get Started</button>
            </Link>
          </div>
        </div>
